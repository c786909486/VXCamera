package com.example.vuandroidadsdk.okhttp.response;
...
import com.example.vuandroidadsdk.okhttp.exception.OkHttpException;
...
import com.example.vuandroidadsdk.okhttp.listener.DisposeHandleCookieListener;
...
public class CommonJsonCallback implements Callback {
    ...
    private ArrayList<String> handleCookie(Headers headers) {
        ...
        Log.d("cookieList",tempList.size()+"");
